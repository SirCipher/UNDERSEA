...
import com.type2labs.coverageplanner.delaunay.model.*;
...
public strictfp class Triangulation {
     ...
     *
     * @throws InvalidVertexException if any two vertices have the same location or if any three
    ...
    public void addVertexToTriangulation(Vertex vertex) throws InvalidVertexException {
        ...
        try {
            ...
            log.debug(String.format("Dropping vertex %s because it outside the triangulation!\nMaybe something went " +
                    "wrong when computing the super triangle?", vertex));
            return;
        }
    ...
    public Collection<Triangle> getCircumcircleTriangles(Vector vertex) throws InvalidVertexException,
